...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   [0] = LAYOUT_all(
		...
		LSFT_T(KC_LEFT_PAREN), KC_NO  , KC_Z   , KC_X   , KC_C   , KC_V   , KC_B   , KC_N   , KC_M   , KC_COMM, KC_DOT  , KC_SLSH , RSFT_T(KC_RIGHT_PAREN), KC_UP  , KC_ESC,
        KC_LCTL  , KC_LALT, KC_LCMD,                            KC_SPC ,                   CMD_T(KC_EQUAL), MO(1)   ,        KC_LEFT, KC_DOWN, KC_RGHT 
	),
   [1] = LAYOUT_all(
